    ...
    render() {
        return (
            <div className="h-full w-full pt-6 bg-transparent relative overflow-hidden overscroll-none window-parent">
                ...
                <RegisterApp name="Adrian" id="home" icon={this.icons.home_folder} position={{ top: 43 + 80 * 2 + 3, right: 4 }} disabled={true} openApp={this.openApp} closeApp={this.closeApp} focus={this.focus} focused_windows={this.state.focused_windows} closed_windows={this.state.closed_windows} />
